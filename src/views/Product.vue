                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                <div class="pd-title">
                                    ...
                                    <a href="#" class="heart-icon"><i class="icon_heart_alt"></i
                    ></a>
                                </div>
                                <div class="pd-rating">
...
import HeaderRocket from "@/components/HeaderRocket.vue";
import FooterRocket from "@/components/FooterRocket.vue";
import RelatedRocket from "@/components/RelatedRocket.vue";
